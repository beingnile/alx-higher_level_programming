...
"""Unittest cases for the module base"""
...
class TestBase_load_from_file_csv(unittest.TestCase):
    ...
    def load_from_file_csv_first_square(self):
        s1 = Square(5, 1, 3, 3)
        s2 = Square(9, 5, 2, 3)
        Square.save_to_file_csv([s1, s2])
    ...
    def load_from_file_csv_second_square(self):
        s1 = Square(5, 1, 3, 3)
        s2 = Square(9, 5, 2, 3)
        Square.save_to_file_csv([s1, s2])
        list_squares_output = Square.load_from_file_csv()
    ...
    def load_from_file_csv_square_types(self):
        s1 = Square(5, 1, 3, 3)
        s2 = Square(9, 5, 2, 3)
        Square.save_to_file_csv([s1, s2])
    ...
    def load_from_no_csv_file(self):
        output = Square.load_from_file_csv()
        self.assertEqual([], output)

    def load_from_file_csv_more_than_one_arg(self):
        with self.assertRaises(TypeError):
